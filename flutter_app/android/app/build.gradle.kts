...
// Fayl bo'lmasa debug kalit ishlatiladi — shunda ham `flutter run --release`
// ishlaydi, lekin bunday APK'ni Play Store qabul qilmaydi.
...
android {
    ...
    compileOptions {
        ...
        // flutter_local_notifications uchun Java 8+ kutubxonalari desugaring talab qiladi
        isCoreLibraryDesugaringEnabled = true
    }

    defaultConfig {
        // TODO: Specify your own unique Application ID (https://developer.android.com/studio/build/application-id.html).
        applicationId = "uz.saler.saler_ai"

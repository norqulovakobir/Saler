...
class _ShopsScreenState extends State<ShopsScreen> {
  ...
  void _apply(dynamic r, {bool append = false}) {
    final items = ((r as Map)['items'] as List).map((e) => Shop.fromJson(e)).toList();
    if (append) {
    ...
    hasMore = r['hasMore'] == true && items.isNotEmpty;
  }
...
class _RelatedProductsState extends State<RelatedProducts> {
  ...
  List<(Product, Shop?)> _parse(dynamic r) =>
      ((r as Map)['items'] as List).map((e) => (Product.fromJson(e), e['shop'] == null ? null : Shop.fromJson(e['shop']))).toList();
